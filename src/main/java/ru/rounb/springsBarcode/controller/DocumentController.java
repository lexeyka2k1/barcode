    ...
    public ResponseEntity<DocumentInfoResponse> getDocumentInfo(@RequestParam String inventoryNumber) {
        try {
         ...
         /*   String url = String.format(
            ...
            String url = "https://opac.rounb.ru/cgiopac/opacg/direct.exe?_version=2.7.0&_service=opacfindd.FindView&outformList%5B0%5D/outform=SHOTFORM&length=1&query/body=(IN+" + inventoryNumber + "%27%27)&userId=GUEST&session=1&iddb=1";
            ...
            return ResponseEntity.ok(
                    new DocumentInfoResponse(inventoryNumber, title != null ? title : "Название не найдено"));
        } catch (Exception e) {
